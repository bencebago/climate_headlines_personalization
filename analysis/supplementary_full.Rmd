...
df <- read.csv('anonim_df.csv', sep=',', header=T, encoding='UTF-8')
...
url <- "https://raw.githubusercontent.com/bencebago/climate_headlines_personalization/main/filtered_data_experiment.json"
...
## 2. Preregistered analysis on engagement
...
## 3. Distribution of responses on categorical prior belief measure
...
## 4. Engagement analysis on extreme and moderate skeptics/believers
...
## 5. Replication of Engagement effects with inattention exclusions
...
## 6. Bookmark regret in skeptics explained by negative sentiments in article texts
...
json_url <- "https://raw.githubusercontent.com/bencebago/climate_headlines_personalization/main/filtered_data_experiment.json"
...
## 8. Linguistic analysis on article headlines
...
## 9. Participant level heterogeneity on Engagement
...
```{r graph for partisanship, fig.cap="Figure S1: Logistic regression plots for upvote and bookmark probability over partisanship. Figure shows regression lines with standard errors.", echo=FALSE, warning=FALSE, message=FALSE, results='asis',  out.width="100%"}
...
```{r graph for news interest, fig.cap="Figure S2: Logistic regression plots for upvote and bookmark probability over self-reported interest in science news. Figure shows regression lines with standard errors.", echo=FALSE, warning=FALSE, message=FALSE, results='asis', out.width="100%"}
...
## 10. Participant level heterogeneity on Regret and Credibility
...
## 11. Robustness check with logistic regression analysis
...
## 12. Prior and Posterior Beliefs
...
## 13. All original and flipped headlines in the experiment
